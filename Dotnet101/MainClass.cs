                    ...
                    switch (num)
                    {
                        case 1:
                            ...
                            if (!string.IsNullOrEmpty(str1))
                                MainClass.StringManipulation(str1);
                            break;
                        case 2:
                            ...
                            {
                                bool response = MainClass.PalindromeCheck(str2);
                        ...
                        case 3:
                            ...
                            if (fib >= 0)
                            {
                                int result = MainClass.Fibonacci(fib);
                        ...
                        case 4:
                            ...
                            if (inpNum > 0) MainClass.PrimeCheck(inpNum);
                            else Console.WriteLine("Please enter a correct positive integer > 0");
                            break;
                        case 5:
                        ...
                        case 6:
                            ...
                            MainClass.Arr2DManipulation(array2D);
                            break;
                        default:
